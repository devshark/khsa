	...
	<table align="center">
		<tr>
			...
			if(isset($_POST['activate'])){
   			...
   			$update_query = mysql_query("UPDATE students SET is_enable = 1  WHERE student_id = '" . $_POST['studentid'] . "' or last_name like ' $find ' ");	
				if($update_query) {
	echo "STUDENT HAS BEEN ACTIVATED!!!!";
	} 
	else{	
	{	
	 die ("Student not Found or Already Active!");
	}
				}
	}

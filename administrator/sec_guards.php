			...
			<tr>
				<td>
					...
					<?php }else{?>
						...
						<font style="color:#009900; font-size:14px;">INTEGRATED INFORMATION SYSTEM</font>
					<?php }?>
				</td>
			</tr>
		</table>
				...
				<tr>
					...
					<td valign="top">
						<?php
			 				...
			 				if(@$_GET['page'] == "population" or @$_GET['page'] == ""){
								include "population.php";
							}else if(@$_GET['page'] == "population"){
								include "population.php";
							}						
						?>

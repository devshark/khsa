			...
			<tr>
				<td nowrap="nowrap">
				 ...
				 <?php }else{?>
					...
					<?php if($_GET['page'] == "" or $_GET['page'] == "student"){?>
					...
					<?php if($_GET['page'] == "candidates"){?>
						<a href="" id="top_nav-link" title="candidates">
							&nbsp;&nbsp;Candidate Information&nbsp;&nbsp;
						</a>
					<?php }else{?>
						<a href="" title="candidates">
							&nbsp;&nbsp;Candidate Information&nbsp;&nbsp;
						</a>
					<?php }?>
					...
					<?php if($_GET['page'] == "position"){?>
						<a href="" id="top_nav-link" title="position">
							&nbsp;&nbsp;Position Information&nbsp;&nbsp;
						</a>
					<?php }else{?>
						<a href="" title="position">
							&nbsp;&nbsp;Position Information&nbsp;&nbsp;
						</a>
					<?php }?>                   
					...
					<?php if($_GET['page'] == "tally"){?>
						<a href="" id="top_nav-link" title="tally">
							&nbsp;&nbsp;Tally Sheet&nbsp;&nbsp;
						</a>
					<?php }else{?>
						<a href="" title="tally">
				...
				<tr>
					...
					<td valign="top">
						<?php
			 				...
			 				if($_GET['page'] == "deactivate" or $_GET['page'] == ""){
								include "deactivate.php";
							}else if($_GET['page'] == "deactive"){
								include "deactivate.php";
							}						
						?>
					</td>

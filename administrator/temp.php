	...
	<table align="center">
		<tr>
			...
			if(isset($_POST['edit'])){
				...
				$sql = "UPDATE evoting.candidates SET  position_id ='" . $_POST['selectpos'] ."', partylist_id='" . $_POST['partylist'] . "', platform='". $_POST['platform']. "', vote_count = '', img='$file_name' WHERE candidates.student_id ='" .$_POST['studentid'] . "'";

  ...
  <div>    
       		<table border="1" width="75%" style="border-collapse:collapse; " cellspacing="0" cellpadding="0">
				...
				<?php
					...
					$student = mysql_query("select students.student_id, last_name, first_name, gender, year, students.section, course_id, is_enable FROM students, students_registrations WHERE students.student_id = students_registrations.student_id and students.is_enable = 2 order by last_name");
                ...
                <tr>
                <td colspan="7">
               <?php $query=mysql_query("SELECT COUNT(student_id) as total_voters from students WHERE is_enable = 2");
